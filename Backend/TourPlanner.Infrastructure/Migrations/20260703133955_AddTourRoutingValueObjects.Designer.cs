...
namespace TourPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260703133955_AddTourRoutingValueObjects")]
    partial class AddTourRoutingValueObjects
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TourPlanner.Domain.Entities.Tour", b =>
                {
                    ...
                    b.OwnsOne("TourPlanner.Domain.ValueObjects.Coordinates", "FromLocation", b1 =>
                        {
                    ...
                    b.OwnsOne("TourPlanner.Domain.ValueObjects.Coordinates", "ToLocation", b1 =>
                        {
                            b1.Property<Guid>("TourId")
                                .HasColumnType("uuid");
